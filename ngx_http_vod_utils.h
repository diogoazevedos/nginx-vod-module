...
ngx_int_t ngx_http_vod_status_to_ngx_error(ngx_http_request_t* r, vod_status_t rc);
...
ngx_int_t ngx_http_vod_set_expires(ngx_http_request_t* r, time_t expires_time);
