...
void ngx_buffer_cache_release(ngx_buffer_cache_t* cache, u_char* key, uint32_t token);
...
void ngx_buffer_cache_get_stats(ngx_buffer_cache_t* cache, ngx_buffer_cache_stats_t* stats);
