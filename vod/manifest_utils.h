...
// constants
#define ADAPTATION_SETS_FLAG_SINGLE_LANG_TRACK (0x1)
#define ADAPTATION_SETS_FLAG_MULTI_AUDIO_CODEC (0x2)
#define ADAPTATION_SETS_FLAG_MULTI_VIDEO_CODEC (0x4)
