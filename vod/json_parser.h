...
typedef vod_status_t (*vod_json_object_value_parser_t)(void* context, vod_json_value_t* value, void* dest);
...
// union parsing
typedef vod_status_t (*json_parser_union_type_parser_t)(void* context, vod_json_object_t* object, void** dest);
...
// misc
vod_status_t vod_json_replace(vod_json_value_t* json1, vod_json_value_t* json2);
